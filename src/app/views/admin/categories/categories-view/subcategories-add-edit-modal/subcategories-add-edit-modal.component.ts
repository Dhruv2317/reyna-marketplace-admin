...
export class SubcategoriesAddEditModalComponent implements OnInit {
  ...
  get category_id() { return this.SubcategoryForm.get('categoryId'); }
  get name() { return this.SubcategoryForm.get('name'); }
  get is_active() { return this.SubcategoryForm.get('isActive'); }
  ...
  async saveOTCSubcategory(formValid: boolean) {
    if (formValid) {
      console.log("Subcategory form : ", this.SubcategoryForm.value);

      const formData: FormData = new FormData();
      var subCategoryFormValues = this.SubcategoryForm.value;
      var subCategoryModel: any = {};

      subCategoryModel.id = subCategoryFormValues.id;
      subCategoryModel.name = subCategoryFormValues.name;
      subCategoryModel.isActive = subCategoryFormValues.is_active;
      ...
      // formObject.imageUrl = this.selectedImageFile;
